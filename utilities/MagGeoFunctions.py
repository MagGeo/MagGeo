...
# 2. Filter Space and time ST-IDW based on GPS points. ST_IDW_Process is a KEY function.
...
def ST_IDW_Process (GPSLat,GPSLong,GPSAltitude,GPSDateTime,GPSTime, TotalSwarmRes_A,TotalSwarmRes_B, TotalSwarmRes_C):
    ...
    DT=14400 #The period of 4 hours but in seconds.
    ...
    #7. Calculating the number of points per satellite that have passed the Space and Time Kernels.
    ...
    #10. Computing the d (hypotenuse computed from the edges ds, dt values
    ...
    SwarmResiduals_ST_filtered['W']= 1/((SwarmResiduals_ST_filtered['Dj'])**2) 
